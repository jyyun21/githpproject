...
public class MyWriteListDao {
	private static MyWriteListDao instance = new MyWriteListDao();

	public MyWriteListDao() {
	}
	public static MyWriteListDao getInstance() {
		return instance;
	}
	/////////// DB연결부분///////////////////////////
	...
	static { // static 변수 초기화 블럭
		try {
			Reader reader = Resources.getResourceAsReader("configuration_myWriteList.xml");
		...
		//file DB
		try {
			Reader reader2 = Resources.getResourceAsReader("configuration_file2.xml");
